...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTA, 22, PIO_SERCOM, PIN_ATTR_PWM_G, No_ADC_Channel, TCC0_CH2, NOT_ON_TIMER, EXTERNAL_INT_6 }, // Serial2 TX, SERCOM3/PAD[0]

  // 13 (LED)
  { PORTA, 23, PIO_SERCOM, PIN_ATTR_PWM_G, No_ADC_Channel, TCC0_CH3, TC4_CH1, EXTERNAL_INT_7 }, // Serial2 RX, SERCOM3/PAD[1]
  ...
  { PORTB,  8, PIO_SERCOM, (PIN_ATTR_ANALOG|PIN_ATTR_PWM_E), ADC_Channel2, TC4_CH0, TC4_CH0, EXTERNAL_INT_8 }, // Serial 3 TX, SERCOM4/PAD[0]
  { PORTB,  9, PIO_SERCOM, (PIN_ATTR_ANALOG|PIN_ATTR_PWM_E), ADC_Channel3, TC4_CH1, TC4_CH1, EXTERNAL_INT_9 }, // Serial 3 RX, SERCOM4/PAD[1]
